        ...
        <View className="glass rounded-t-3xl h-[90%]">
          ...
          <View className="p-6 pb-2">
            <View className="flex-row justify-between items-center mb-2">
              ...
              <TouchableOpacity onPress={onClose} className="p-2 bg-gray-100 rounded-full dark:bg-gray-700">
                <Ionicons name="close" size={20} color="#374151" className="dark:text-white" />
              </TouchableOpacity>
            </View>
          </View>
